...
import { ArrowLeft, ArrowRight, Mail, ShieldCheck, User } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#070708] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_center,_rgba(99,102,241,0.05)_0%,_#070708_70%)] font-inter">
            <div className="max-w-xl mx-auto animate-fade-in animate-zoom-in">
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-500 text-sm font-medium tracking-wide uppercase">Tạo tài khoản quản trị</p>
                </div>
                ...
                <div className="bg-[#111114] border border-white/[0.08] rounded-2xl p-8 shadow-2xl shadow-indigo-500/10 backdrop-blur-xl bg-white/[0.02]">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-zinc-500 pl-1 uppercase tracking-wider">Họ và tên</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-zinc-500 pl-1 uppercase tracking-wider">Mật khẩu</label>
                            <div className="relative group">
                                <input
                                    type="password"
                                    required
