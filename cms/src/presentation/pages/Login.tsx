...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#070708] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_center,_rgba(99,102,241,0.05)_0%,_#070708_70%)]">
            <div className="w-full max-w-md mx-auto animate-fade-in animate-zoom-in">
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-500 text-sm font-medium tracking-wide uppercase">Hệ thống Quản trị</p>
                </div>
                ...
                <div className="bg-[#111114] border border-white/[0.08] rounded-2xl p-8 shadow-2xl shadow-indigo-500/10 backdrop-blur-xl bg-white/[0.02]">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <button
                                    ...
                                    className="text-[10px] font-bold text-indigo-400 hover:text-indigo-300 transition-colors uppercase tracking-widest bg-transparent border-none p-0"
                                >
                                    Quên mật khẩu?
                                </button>
                            </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/5 text-center">
                        <p className="text-xs text-zinc-500">
                            Chưa có tài khoản? <button onClick={() => navigate('/register')} className="text-indigo-400 font-bold hover:underline bg-transparent border-none p-0">Đăng ký ngay</button>
                        </p>
                    </div>
                </div>
